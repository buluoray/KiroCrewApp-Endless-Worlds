	...
	*/
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			readerBar ? null : /* @__PURE__ */ jsxs("div", {
				className: "ew-topbar",
				children: [/* @__PURE__ */ jsx("button", {
					className: "ew-back",
					type: "button",
			...
			readerBar ? createPortal(/* @__PURE__ */ jsxs("div", {
				className: `ew-readerbar${barHidden ? " ew-readerbar-hidden" : ""}`,
				children: [/* @__PURE__ */ jsx("button", {
					className: "ew-back",
					type: "button",
					onClick: onBack,
...
function EndlessWorlds() {
	...
	*/
	...
	return /* @__PURE__ */ jsx(LanguageContext.Provider, {
		value: applyLanguage,
		children: /* @__PURE__ */ jsxs("div", {
			className: "ew-root ew-view-" + view + " ew-w-" + readWidth + (view === "library" ? " ew-home" : ""),
			lang,
			ref: rootRef,
			children: [
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								style: {
									...
									paddingBottom: narrowLive ? "calc(72px + 60px)" : void 0
								},
								children: body
							}),
							view === "library" && !hideBody ? /* @__PURE__ */ jsx("div", {
								className: "ew-version",
								children: t("app.version", { version: "0.5.6" })
							}) : null,
