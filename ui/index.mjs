...
function TurnProgress({ stage }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx("div", { className: `ew-progress-fill${writing ? " ew-progress-writing" : ""}` })
		}), /* @__PURE__ */ jsxs("div", {
			className: "ew-progress-steps",
			children: [/* @__PURE__ */ jsx("span", {
				className: "ew-progress-label",
				children: writing ? t("play.stage.writing") : t("play.stage.reading")
			}), /* @__PURE__ */ jsx("span", {
				className: "ew-progress-count",
				children: writing ? "2 / 2" : "1 / 2"
			})]
		})]
	});
}
	...
	if (v.awaitingOpening) return /* @__PURE__ */ jsxs("div", { children: [
		...
		generating ? /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(TurnProgress, { stage: v.generating?.stage })
			]
	...
	const main = /* @__PURE__ */ jsxs("div", { children: [
		...
		isLive ? /* @__PURE__ */ jsxs("div", { children: [
			...
			generating ? /* @__PURE__ */ jsx("div", {
				className: "ew-note ew-note-live",
				children: /* @__PURE__ */ jsx(TurnProgress, { stage: v.generating?.stage })
			}) : null,
