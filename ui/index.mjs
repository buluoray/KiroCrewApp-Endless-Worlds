...
var api = {
	...
	*  the server names the proxy explicitly in `creditNote`. */
	perf: (runId) => json(`/runs/${encodeURIComponent(runId)}/perf`),
	...
	*  and it is only ever looked at one turn at a time. */
	turnStages: (runId, turn) => json(`/runs/${encodeURIComponent(runId)}/backdrop-timeline?turn=${encodeURIComponent(turn)}`),
...
var TABLES$1 = {
	zh: {
		...
		"settings.group.narration": "叙事",
		"settings.group.art": "页面配图",
		"settings.group.choices": "选项装饰",
		"settings.proseLength": "篇幅",
		"settings.proseLength.default": "跟随世界",
		"settings.proseLength.short": "短（两三段）",
		"settings.proseLength.long": "长（五段以上）",
		"settings.backdrops": "启用配图",
		"settings.backdrops.on": "重要场景会配上插画",
		"settings.backdrops.off": "纯文字模式，回合更快、更省",
		"settings.styles": "画风",
		"settings.style.photo": "照片描摹",
		"settings.style.watercolor": "水彩",
		"settings.style.oil": "油画",
		"settings.style.minimal": "极简",
		"settings.cadence": "配图频率",
		"settings.cadence.normal": "叙事者决定",
		"settings.cadence.sparse": "省着画（至少隔 5 回合）",
		"settings.choiceArt": "选项徽章",
		"settings.choiceArt.hint": "重大抉择按钮背后的小纹章",
		"settings.choiceEffects": "选项特效",
		"settings.choiceEffects.hint": "微光、余烬等命运时刻的动效",
		"settings.artQuality": "出图速度",
		"settings.artQuality.standard": "标准（画师复查一轮）",
		"settings.artQuality.fast": "快（一稿即发，省时省费）",
		"settings.reducedMotion": "减少动效",
		"settings.reducedMotion.hint": "静止呈现所有背景与徽章，立即生效",
		"delete.cancel": "不删了",
		...
		"life.perf.short": "性能面板",
		"life.perf.aria": "打开「{name}」的性能面板",
		"perf.back": "返回",
		"perf.title": "性能 — {name}",
		...
		"perf.fallback": "（兜底）",
		"perf.artPending": "绘制中…",
		"perf.rotationChapter": "新对话：开启新章",
		"perf.rotationBudget": "新对话：回合预算",
		"perf.rotationInstall": "新对话：应用更新",
		"perf.rotationClosed": "新对话：标签页关闭",
		"perf.rotationOther": "新对话",
		"perf.caption": "「{name}」每个回合的耗时与用量",
		"perf.openStages": "看阶段明细",
		"perf.toolCalls": "工具调用",
		"perf.trail": "调用顺序",
		"perf.trailMore": "另有 {count} 次",
		"perf.model": "模型",
		"perf.laneStory": "故事阶段",
		"perf.laneArt": "画图阶段",
		"perf.stagesLoading": "读取阶段记录…",
		"perf.stagesNone": "这一回合没有留下画图记录。",
		"perf.thought": "思考 {took}",
		"perf.onServer": "· 服务端 {took}",
		"perf.stageRequested": "请求背景图",
		"perf.stageRead": "叙述者读取状态",
		"perf.stageWrote": "写作并提交",
		"perf.stageCommit": "提交回合",
		"perf.stageAskArt": "交付画图任务",
		"perf.stageTrace": "检索并描摹参考图",
		"perf.stagePickRef": "挑选参考图",
		"perf.stageDraft": "提交草稿",
		"perf.stagePublish": "发布背景图",
		"perf.stageHandDrawn": "叙述者手绘兜底",
		"perf.stageRetry": "重新派发绘图",
		"perf.stageRetryDone": "重试成功",
		"perf.stageRetryTimeout": "重试超时",
		"perf.stageServerDrew": "服务端直接兜底",
	...
	en: {
		...
		"settings.group.narration": "Narration",
		"settings.group.art": "Page art",
		"settings.group.choices": "Choice decoration",
		"settings.proseLength": "Length",
		"settings.proseLength.default": "Follow the world",
		"settings.proseLength.short": "Short (2–3 paragraphs)",
		"settings.proseLength.long": "Long (5+ paragraphs)",
		"settings.backdrops": "Page art",
		"settings.backdrops.on": "Key scenes get an illustration",
		"settings.backdrops.off": "Text only — faster, cheaper turns",
		"settings.styles": "Styles",
		"settings.style.photo": "Photo trace",
		"settings.style.watercolor": "Watercolor",
		"settings.style.oil": "Oil",
		"settings.style.minimal": "Minimal",
		"settings.cadence": "Art cadence",
		"settings.cadence.normal": "Narrator decides",
		"settings.cadence.sparse": "Sparse (5+ turns apart)",
		"settings.choiceArt": "Choice emblems",
		"settings.choiceArt.hint": "The small crest behind fateful buttons",
		"settings.choiceEffects": "Choice effects",
		"settings.choiceEffects.hint": "Shimmer, embers and other fateful motion",
		"settings.artQuality": "Art speed",
		"settings.artQuality.standard": "Standard (one review pass)",
		"settings.artQuality.fast": "Fast (first draft ships)",
		"settings.reducedMotion": "Reduce motion",
		"settings.reducedMotion.hint": "Backdrops and emblems render still, effective immediately",
		...
		"life.perf.short": "Performance",
		"life.perf.aria": "Open the performance page for: {name}",
		"perf.back": "Back",
		...
		"perf.story": "Story",
		"perf.art": "Art",
		"perf.declared": "Declared",
		"perf.tokens": "Tokens",
		"perf.context": "Context",
		"perf.events": "Events",
		"perf.formPatch": "patch",
		"perf.formFull": "full",
		"perf.fallback": "(fallback)",
		"perf.artPending": "painting…",
		"perf.rotationChapter": "fresh chat: new chapter",
		"perf.rotationBudget": "fresh chat: turn budget",
		"perf.rotationInstall": "fresh chat: app updated",
		"perf.rotationClosed": "fresh chat: tab closed",
		"perf.rotationOther": "fresh chat",
		"perf.caption": "Time and usage for each turn of: {name}",
		"perf.openStages": "see stages",
		"perf.toolCalls": "Tool calls",
		"perf.trail": "In order",
		"perf.trailMore": "+{count} more",
		"perf.model": "Model",
		"perf.laneStory": "Story stages",
		"perf.laneArt": "Art stages",
		"perf.stagesLoading": "reading the stage record…",
		"perf.stagesNone": "This turn left no art record.",
		"perf.thought": "thinking {took}",
		"perf.onServer": "· server {took}",
		"perf.stageRequested": "backdrop requested",
		"perf.stageRead": "narrator read the state",
		"perf.stageWrote": "wrote and committed",
		"perf.stageCommit": "turn committed",
		"perf.stageAskArt": "art handed off",
		"perf.stageTrace": "searched and traced a reference",
		"perf.stagePickRef": "picked a reference",
		"perf.stageDraft": "draft submitted",
		"perf.stagePublish": "backdrop published",
		"perf.stageHandDrawn": "narrator hand-drew a fallback",
		"perf.stageRetry": "illustrator re-dispatched",
		"perf.stageRetryDone": "retry landed",
		"perf.stageRetryTimeout": "retry ran out of time",
		"perf.stageServerDrew": "server drew it instead",
...
var Bar$1 = ({ pct }) => /* @__PURE__ */ jsx("div", {
...
function Value({ f }) {
	switch (f.kind) {
		...
		case "resource": return /* @__PURE__ */ jsxs("div", { children: [
			...
			f.pct != null ? /* @__PURE__ */ jsx(Bar$1, { pct: f.pct }) : null
		] });
...
* left it.
*/
function LifeRow({ run, onOpen, onDeleted, onArchive, onRename, onPerf }) {
...
function Bar({ value, max }) {
	...
	return /* @__PURE__ */ jsx("span", {
		className: "ew-perfbar",
		"aria-hidden": "true",
		children: /* @__PURE__ */ jsx("span", {
			className: "ew-perfbar-fill",
			style: { width: `${pct}%` }
		})
	});
}
function ms(v) {
	...
	return v >= 1e4 ? `${Math.round(v / 1e3)}s` : `${(v / 1e3).toFixed(1)}s`;
}
function kb(bytes) {
	return bytes === void 0 ? "—" : `${(bytes / 1024).toFixed(1)}KB`;
}
/** Explicit per-reason lookups so every catalog key appears verbatim. */
function rotationLabel(reason) {
...
function stageLabel(step) {
	...
	return step.startsWith("tool:") ? step.slice(5) : step;
}
...
*/
function Stages({ runId, row }) {
	const [trace, setTrace] = useState(null);
	const [problem, setProblem] = useState("");
	useEffect(() => {
		let alive = true;
		api.turnStages(runId, row.turn).then((out) => {
	...
	const wrote = row.storyMs !== void 0 && row.readMs !== void 0 && row.storyMs >= row.readMs ? row.storyMs - row.readMs : void 0;
	const trail = row.tools ?? [];
	const clipped = row.toolCalls !== void 0 && row.toolCalls > trail.length ? row.toolCalls - trail.length : 0;
	const dup = (key) => NARROW_HIDDEN.includes(key);
	const facts = [
		{
			key: "perf.declared",
		...
		{
			key: "perf.tokens",
			value: row.usedTokens !== void 0 ? row.usedTokens.toLocaleString() : "—"
		},
		{
			key: "perf.context",
			value: row.pct !== void 0 ? `${row.pct}%` : "—"
		}
	];
	if (row.credits !== void 0) facts.push({
		key: "perf.credits",
		value: row.credits.toFixed(2)
	});
	if (row.toolCalls !== void 0) facts.push({
		key: "perf.toolCalls",
		value: String(row.toolCalls)
	});
	if (row.model) facts.push({
		key: "perf.model",
		value: row.model
	});
	if (row.rotation) facts.push({
		key: "perf.events",
		value: rotationLabel(row.rotation)
	});
	const events = trace?.events ?? [];
	return /* @__PURE__ */ jsxs("div", {
		className: "ew-perf-stages",
		children: [
			/* @__PURE__ */ jsx("dl", {
				className: "ew-perf-facts",
				children: facts.map((f) => /* @__PURE__ */ jsxs("div", {
					className: `ew-perf-fact${dup(f.key) ? " ew-perf-fact-dup" : ""}`,
					children: [/* @__PURE__ */ jsx("dt", { children: t(f.key) }), /* @__PURE__ */ jsx("dd", { children: f.value })]
				}, f.key))
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "ew-perf-lane",
				children: [
					/* @__PURE__ */ jsx("div", {
						className: "ew-perf-lanehead",
						children: t("perf.laneStory")
					}),
					/* @__PURE__ */ jsxs("ul", {
						className: "ew-perf-steps",
						children: [/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("span", {
							className: "ew-perf-step",
							children: t("perf.stageRead")
						}), /* @__PURE__ */ jsx("span", {
							className: "ew-perf-took",
							children: ms(row.readMs)
						})] }), /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("span", {
							className: "ew-perf-step",
							children: t("perf.stageWrote")
						}), /* @__PURE__ */ jsx("span", {
							className: "ew-perf-took",
							children: ms(wrote)
						})] })]
					}),
					trail.length ? /* @__PURE__ */ jsxs("div", {
						className: "ew-perf-trail",
						children: [/* @__PURE__ */ jsx("span", {
							className: "ew-perf-traillabel",
							children: t("perf.trail")
						}), /* @__PURE__ */ jsxs("span", {
							className: "ew-perf-trailseq",
							children: [trail.map((name) => stageLabel(`tool:${name}`)).join(" → "), clipped ? ` → ${t("perf.trailMore", { count: clipped })}` : ""]
						})]
					}) : null
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						className: "ew-perf-lanehead",
						children: t("perf.laneArt")
					}),
					problem ? /* @__PURE__ */ jsx("div", {
						className: "ew-modal-problem",
						children: problem
					}) : null,
					!problem && trace === null ? /* @__PURE__ */ jsx("div", {
						className: "ew-meta",
						children: t("perf.stagesLoading")
					}) : null,
					trace !== null && events.length === 0 ? /* @__PURE__ */ jsx("div", {
						className: "ew-meta",
						children: t("perf.stagesNone")
					}) : null,
					events.length ? /* @__PURE__ */ jsx("ul", {
						className: "ew-perf-steps",
						children: events.map((e, i) => /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsxs("span", {
							className: "ew-perf-step",
							children: [stageLabel(e.step), e.attempt !== void 0 ? ` #${e.attempt}` : ""]
						}), /* @__PURE__ */ jsxs("span", {
							className: "ew-perf-took",
							children: [e.gapMs !== void 0 && e.gapMs !== null ? t("perf.thought", { took: ms(e.gapMs) }) : "", e.serverMs !== void 0 ? ` ${t("perf.onServer", { took: ms(e.serverMs) })}` : ""]
						})] }, `${e.step}-${e.at}-${i}`))
					}) : null
				]
			})
...
function PerfPage({ runId, name, onBack }) {
	...
	*  are meant to explain off the screen, on a phone especially. */
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "ew-perf-head",
				children: [/* @__PURE__ */ jsx("button", {
					className: "ew-btn ew-btn-quiet",
					type: "button",
					onClick: onBack,
					children: t("perf.back")
				}), /* @__PURE__ */ jsx("h2", {
					className: "ew-perf-title",
					children: t("perf.title", { name })
				})]
			}),
			/* @__PURE__ */ jsx("div", {
				className: "ew-meta",
			...
			turns !== null && rows.length === 0 ? /* @__PURE__ */ jsx("div", {
				className: "ew-meta",
				children: t("perf.empty")
			}) : null,
			rows.length ? /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					className: "ew-perf-table",
					children: [
						/* @__PURE__ */ jsx("caption", {
							id: "ew-perf-caption",
							className: "ew-perf-caption",
							children: t("perf.caption", { name })
						}),
						/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
							/* @__PURE__ */ jsx("th", { children: t("perf.turn") }),
							/* @__PURE__ */ jsx("th", { children: t("perf.story") }),
							/* @__PURE__ */ jsx("th", { children: t("perf.art") }),
							/* @__PURE__ */ jsx("th", {
								className: "ew-perf-rest",
								children: t("perf.declared")
							}),
							hasCredits ? /* @__PURE__ */ jsx("th", {
								className: "ew-perf-rest",
								children: t("perf.credits")
							}) : null,
							/* @__PURE__ */ jsx("th", {
								className: "ew-perf-rest",
								children: t("perf.tokens")
							}),
							/* @__PURE__ */ jsx("th", {
								className: "ew-perf-rest",
								children: t("perf.context")
							}),
							/* @__PURE__ */ jsx("th", {
								className: "ew-perf-rest",
								children: t("perf.events")
							})
						] }) }),
						/* @__PURE__ */ jsx("tbody", { children: rows.map((r) => {
							const open = openTurn === r.turn;
							return [/* @__PURE__ */ jsxs("tr", {
								className: "ew-perf-row",
								children: [
									/* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsxs("button", {
										...
										children: [
											/* @__PURE__ */ jsx("span", {
												className: "ew-perf-caret",
												"aria-hidden": "true",
												children: open ? "▾" : "▸"
											}),
											r.turn,
											/* @__PURE__ */ jsx("span", {
												className: "ew-perf-openhint",
												children: t("perf.openStages")
											})
										]
									}) }),
									/* @__PURE__ */ jsxs("td", { children: [
										ms(r.storyMs),
										" ",
										r.storyMs !== void 0 ? /* @__PURE__ */ jsx(Bar, {
											value: r.storyMs,
											max: maxStory
										}) : null
									] }),
									/* @__PURE__ */ jsx("td", { children: r.artMs !== void 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
										ms(r.artMs),
										" ",
										/* @__PURE__ */ jsx(Bar, {
											value: r.artMs,
									...
									/* @__PURE__ */ jsxs("td", {
										className: "ew-perf-rest",
										children: [r.form ? t(r.form === "patch" ? "perf.formPatch" : "perf.formFull") : "—", r.declaredBytes !== void 0 ? ` ${kb(r.declaredBytes)}` : ""]
									}),
									hasCredits ? /* @__PURE__ */ jsx("td", {
										className: "ew-perf-rest",
										children: r.credits !== void 0 ? r.credits.toFixed(2) : "—"
									}) : null,
									/* @__PURE__ */ jsx("td", {
										className: "ew-perf-rest",
										children: r.usedTokens !== void 0 ? r.usedTokens.toLocaleString() : "—"
									}),
									/* @__PURE__ */ jsx("td", {
										className: "ew-perf-rest",
										children: r.pct !== void 0 ? `${r.pct}%` : "—"
									}),
									/* @__PURE__ */ jsx("td", {
										className: "ew-perf-rest",
										children: r.rotation ? rotationLabel(r.rotation) : ""
									})
								]
							}, r.turn), open ? /* @__PURE__ */ jsx("tr", {
								className: "ew-perf-stagerow",
								children: /* @__PURE__ */ jsx("td", {
									colSpan: columns,
									id: `ew-perf-stages-${r.turn}`,
									children: /* @__PURE__ */ jsx(Stages, {
										runId,
										row: r
									})
								})
...
var SCENE_RENDER_DEADLINE_MIN_MS = 700;
var SCENE_RENDER_DEADLINE_MAX_MS = 6e3;
...
var SCENE_RENDER_DEADLINE_FACTOR = 5;
var SCENE_RENDER_PARSE_ALLOWANCE_MS = 300;
function renderDeadlineMs(fetchMs) {
	...
	*  surface. 0 until the fetch lands, which is also before any frame exists. */
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			waiting ? /* @__PURE__ */ jsx("div", {
				className: "ew-slot-wait",
				"aria-hidden": "true"
			}) : null,
			everNeeded ? /* @__PURE__ */ jsx("iframe", {
				title: t("play.sceneTitle"),
				className: `ew-slot${on && !failed ? " ew-slot-on" : ""}`,
				style: failed ? { display: "none" } : waiting ? {
					opacity: 0,
					pointerEvents: "none"
				} : on && fitH ? { height: `${fitH}px` } : void 0,
...
function SettingsPanel({ onClose }) {
	...
	const [styles, setStyles] = useState([...PAINT_STYLES]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "ew-settings-group",
				children: t("settings.group.narration")
			}),
			/* @__PURE__ */ jsxs("label", {
			...
			/* @__PURE__ */ jsxs("label", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					className: "ew-settings-label",
					children: t("settings.proseLength")
				}), /* @__PURE__ */ jsxs("select", {
					className: "ew-uilang ew-settings-select",
					value: proseLength,
					onChange: (e) => {
					...
					children: [
						/* @__PURE__ */ jsx("option", {
							value: "",
							children: t("settings.proseLength.default")
						}),
						/* @__PURE__ */ jsx("option", {
							value: "short",
							children: t("settings.proseLength.short")
						}),
						/* @__PURE__ */ jsx("option", {
							value: "long",
							children: t("settings.proseLength.long")
						})
					]
				})]
			}),
			...
			/* @__PURE__ */ jsxs("label", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("span", {
						className: "ew-settings-note",
						children: backdrops ? t("settings.backdrops.on") : t("settings.backdrops.off")
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: backdrops ? "" : "ew-settings-dimmed",
				children: [
					/* @__PURE__ */ jsxs("label", {
						className: "ew-settings-row",
						children: [/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							className: "ew-settings-label",
							children: t("settings.styles")
						}), /* @__PURE__ */ jsx("div", {
							className: "ew-settings-checks",
							children: PAINT_STYLES.map((style) => /* @__PURE__ */ jsxs("label", {
								className: "ew-settings-check",
								children: [/* @__PURE__ */ jsx("input", {
									type: "checkbox",
									checked: styles.includes(style),
									disabled: !backdrops,
									onChange: () => toggleStyle(style)
								}), /* @__PURE__ */ jsx("span", { children: t(`settings.style.${style}`) })]
							}, style))
						})]
					}),
					/* @__PURE__ */ jsxs("label", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: [/* @__PURE__ */ jsx("option", {
								value: "normal",
								children: t("settings.cadence.normal")
							}), /* @__PURE__ */ jsx("option", {
								value: "sparse",
								children: t("settings.cadence.sparse")
							})]
						})]
					}),
					/* @__PURE__ */ jsxs("label", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							className: "ew-settings-label",
							children: t("settings.artQuality")
						}), /* @__PURE__ */ jsxs("select", {
							className: "ew-uilang ew-settings-select",
							value: artQuality,
							disabled: !backdrops,
							...
							children: [/* @__PURE__ */ jsx("option", {
								value: "standard",
								children: t("settings.artQuality.standard")
							}), /* @__PURE__ */ jsx("option", {
								value: "fast",
								children: t("settings.artQuality.fast")
							})]
						})]
					})
				]
			...
			/* @__PURE__ */ jsxs("label", {
				...
				children: [
					/* @__PURE__ */ jsx("span", {
						className: "ew-settings-label",
						children: t("settings.reducedMotion")
					}),
					/* @__PURE__ */ jsx("input", {
						type: "checkbox",
					...
					/* @__PURE__ */ jsx("span", {
						className: "ew-settings-note",
						children: t("settings.reducedMotion.hint")
					})
				]
			}),
			/* @__PURE__ */ jsx("div", {
				className: "ew-settings-group",
				children: t("settings.group.choices")
			}),
			/* @__PURE__ */ jsxs("label", {
				className: "ew-settings-row",
				children: [
					...
					/* @__PURE__ */ jsx("span", {
						className: "ew-settings-note",
						children: t("settings.choiceArt.hint")
					})
				]
			}),
			/* @__PURE__ */ jsxs("label", {
				...
				children: [
					/* @__PURE__ */ jsx("span", {
						className: "ew-settings-label",
						children: t("settings.choiceEffects")
					}),
					/* @__PURE__ */ jsx("input", {
						type: "checkbox",
					...
					/* @__PURE__ */ jsx("span", {
						className: "ew-settings-note",
						children: t("settings.choiceEffects.hint")
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
...
function EndlessWorlds() {
	...
	*  section, polled to completion, then reviewed and installed. */
	...
	const [perfRun, setPerfRun] = useState(null);
	...
	*  map, and leaves the last frame under the bar. */
	...
	let body;
	if (view === "perf" && perfRun) body = /* @__PURE__ */ jsx(PerfPage, {
		runId: perfRun.runId,
		name: perfRun.name,
		onBack: () => {
			setPerfRun(null);
	...
	else if (view === "live" && live) body = /* @__PURE__ */ jsx(PlayPage, {
		runId: live,
		onBack: home,
		onScenes: setScenes,
					...
					children: [/* @__PURE__ */ jsx(WorldRail, {
						...
						children: [
							...
							view === "library" && !hideBody ? /* @__PURE__ */ jsx("div", {
								...
								children: t("app.version", { version: "0.12.2" })
							}) : null,
