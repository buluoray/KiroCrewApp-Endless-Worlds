		...
		isLive && (v.choices ?? []).length ? /* @__PURE__ */ jsx("div", {
			...
			children: (v.choices ?? []).map((c) => {
				...
				return /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("button", {
						className: "ew-choice" + (c.fateful || c.art ? " ew-choice-fateful" : "") + (c.art ? " ew-choice-arted" : "") + (armed ? " ew-choice-armed" : "") + (writing ? " ew-choice-waiting" : "") + (dimmed ? " ew-choice-dimmed" : ""),
						type: "button",
						disabled: busy,
						"aria-pressed": armed,
						"aria-busy": writing,
