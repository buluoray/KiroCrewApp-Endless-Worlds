...
function PerfPage({ runId, name, onBack }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			rows.length ? /* @__PURE__ */ jsxs("table", {
				...
				children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
					...
					/* @__PURE__ */ jsx("td", { children: r.turn }),
					...
					children: [/* @__PURE__ */ jsx(WorldRail, {
						...
						children: [
							...
							view === "library" && !hideBody ? /* @__PURE__ */ jsx("div", {
								...
								children: t("app.version", { version: "0.10.2" })
							}) : null,
