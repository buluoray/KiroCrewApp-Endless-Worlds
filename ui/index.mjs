...
var TABLES = {
	zh: {
		...
		"play.stage.reading": "叙事者正在翻阅这条人生…",
		"play.stage.writing": "正在落笔下一页…",
		"play.steps": "{n} 步",
		"play.tool.read": "正在翻阅这条人生…",
		"play.tool.scene": "正在布置场景…",
		"play.tool.await": "正在等待你的回应…",
		"play.tool.write": "正在落笔成页…",
		"play.tool.pack": "正在梳理这个世界…",
	...
	en: {
		...
		"play.stage.reading": "The narrator is reading this life…",
		"play.stage.writing": "Writing the next page…",
		"play.steps": "{n} steps",
		"play.tool.read": "Reading this life…",
		"play.tool.scene": "Setting a scene…",
		"play.tool.await": "Awaiting your response…",
		"play.tool.write": "Writing the page…",
		"play.tool.pack": "Shaping the world…",
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					plays > 0 ? /* @__PURE__ */ jsx("div", {
						style: { marginTop: "4px" },
						children: t("world.plays", { n: plays })
					}) : null
				]
			})
		]
...
function TurnProgress({ g }) {
	...
	const label = toolKey ? t(toolKey) : writing ? t("play.stage.writing") : t("play.stage.reading");
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				children: label
			}), steps > 0 ? /* @__PURE__ */ jsx("span", {
				className: "ew-progress-count",
				children: t("play.steps", { n: steps })
			}) : null]
		})]
	});
}
	...
	*/
	...
	if (v.awaitingOpening) return /* @__PURE__ */ jsxs("div", { children: [
		...
		generating ? /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(Waiting, { label: arrange || t("opening.arranging") }),
				/* @__PURE__ */ jsx(TurnProgress, { g: v.generating })
			]
	...
	const main = /* @__PURE__ */ jsxs("div", { children: [
		(v.unlocked ?? []).length ? /* @__PURE__ */ jsx("div", {
			...
			role: "status",
			"aria-live": "polite",
			children: (v.unlocked ?? []).map((h, i) => /* @__PURE__ */ jsx("div", {
		...
		isLive ? /* @__PURE__ */ jsxs("div", { children: [
			...
			generating ? /* @__PURE__ */ jsx("div", {
				className: "ew-note ew-note-live",
				children: /* @__PURE__ */ jsx(TurnProgress, { g: v.generating })
			}) : null,
