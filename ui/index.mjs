	...
	*/
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "ew-topbar" + (readerBar ? " ew-topbar-float" : "") + (readerBar && barHidden ? " ew-topbar-hidden" : ""),
				children: [/* @__PURE__ */ jsx("button", {
					className: "ew-back",
					type: "button",
					onClick: onBack,
