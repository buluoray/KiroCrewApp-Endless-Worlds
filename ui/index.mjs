...
var TABLES = {
	zh: {
		...
		"delete.counting": "正在清点这个世界里还剩几条人生…",
		"delete.done": "世界已删除。",
		...
		"play.stalled": "这一页迟迟没有落笔。你的原话还在，再试一次。",
		"play.turn": "第 {turn} 回合",
		"play.page": "第 {n} 页",
		"play.prevTurn": "上一回合",
		"play.nextTurn": "下一回合",
		...
		"world.opening": "开局会问你",
		"world.worldDecidesHint": "高亮的项由世界决定，你无法挑选。",
	...
	en: {
		...
		"history.noMatches": "No months mention “{q}”.",
		...
		"opening.next": "Next",
		"opening.notStarted": "The prologue has not begun. Everything you chose is safe.",
		...
		"world.loreHide": "Hide the world's lore",
		"world.loreShow": "Read this world's lore",
		"world.languagePick": "Play this world in",
		...
		"world.worldDecidesHint": "Highlighted choices are settled by the world — you can't pick them.",
