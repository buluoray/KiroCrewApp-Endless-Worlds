...
def life_chronicle():
    ...
    return [
        turn_entry(1, {
            ...
            "events": [
                {"key": "saved", "title": "救出艾琳", "summary": "s",
                 "importance": "major", "participants": ["player", "elin"],
                 "place": "bridge",
                 "threads": [{"id": "debt", "effect": "opened"}],
                 "disclosure": "known"},
                {"key": "watcher", "title": "有人在暗处看见了这一幕", "summary": "s",
                 "importance": "major", "participants": ["elin"],
                 "disclosure": "hidden"},
            ],
            "relations": [
        ...
        }, action="把她拉上岸", prose="洪水冲桥，你把艾琳拉上岸。"),
        turn_entry(5, {
            "events": [
...
def test_a_minor_unechoed_event_stays_out_of_the_sparse_view():
    chronicle = life_chronicle() + [turn_entry(6, {
